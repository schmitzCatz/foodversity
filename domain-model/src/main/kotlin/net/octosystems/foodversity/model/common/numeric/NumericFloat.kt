...
data class NumericFloat(val value: Float) : Numeric {
...
private fun Float.rem(num: Number): Number = when (num) {
...
private fun Float.div(num: Number): Number = when (num) {
...
private fun Float.times(num: Number): Number = when (num) {
...
private fun Float.plus(num: Number): Number = when (num) {
...
private fun Float.minus(num: Number): Number = when (num) {
