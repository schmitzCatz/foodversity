...
data class NumericByte(val value: Byte) : Numeric {
...
private fun Byte.rem(num: Number): Number = when (num) {
...
private fun Byte.div(num: Number): Number = when (num) {
...
private fun Byte.times(num: Number): Number = when (num) {
...
private fun Byte.plus(num: Number): Number = when (num) {
...
private fun Byte.minus(num: Number): Number = when (num) {
