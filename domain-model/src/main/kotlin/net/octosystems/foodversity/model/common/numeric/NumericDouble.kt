...
data class NumericDouble(val value: Double) : Numeric {

    constructor(value: Numeric) : this(value.toDouble())
    ...
    companion object {
        fun of(value: Number) = NumericDouble(value.toDouble())
    }
}

private fun Double.rem(num: Number): Number = when (num) {
...
private fun Double.div(num: Number): Number = when (num) {
...
private fun Double.times(num: Number): Number = when (num) {
...
private fun Double.plus(num: Number): Number = when (num) {
...
private fun Double.minus(num: Number): Number = when (num) {
