...
data class NumericLong(val value: Long) : Numeric {
...
private fun Long.rem(num: Number): Number = when (num) {
...
private fun Long.div(num: Number): Number = when (num) {
...
private fun Long.times(num: Number): Number = when (num) {
...
private fun Long.plus(num: Number): Number = when (num) {
...
private fun Long.minus(num: Number): Number = when (num) {
