...
@JvmInline
value class Pound(val value: NumericDouble) : net.octosystems.foodversity.model.common.units.weight.WeightUnit, Numeric by value {

    override fun getSymbol(): net.octosystems.foodversity.model.common.units.UnitSymbol = net.octosystems.foodversity.model.common.units.UnitSymbol.of("lbs")
    ...
    override fun toPound(): net.octosystems.foodversity.model.common.units.weight.Pound =
        net.octosystems.foodversity.model.common.units.weight.Pound(value)

    companion object {
        fun of(value: Number) =
            net.octosystems.foodversity.model.common.units.weight.Pound(NumericDouble(value.toDouble()))
        fun of(value: net.octosystems.foodversity.model.common.units.weight.Gram) =
            net.octosystems.foodversity.model.common.units.weight.Pound(NumericDouble(value / 453.59237))
        fun of(value: net.octosystems.foodversity.model.common.units.weight.Kilogram) =
            net.octosystems.foodversity.model.common.units.weight.Pound(NumericDouble(value * 2.2046))
        fun of(value: net.octosystems.foodversity.model.common.units.weight.Milligram) =
            net.octosystems.foodversity.model.common.units.weight.Pound(NumericDouble(value * 0.000002205))
    }
}
