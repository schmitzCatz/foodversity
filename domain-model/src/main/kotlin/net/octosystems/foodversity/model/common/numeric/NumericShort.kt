...
data class NumericShort(val value: Short) : Numeric {
...
private fun Short.rem(num: Number): Number = when (num) {
...
private fun Short.div(num: Number): Number = when (num) {
...
private fun Short.times(num: Number): Number = when (num) {
...
private fun Short.plus(num: Number): Number = when (num) {
...
private fun Short.minus(num: Number): Number = when (num) {
