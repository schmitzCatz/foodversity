...
class JouleTest {
    ...
    fun `Symbol of Joule should be 'J'`() {
        val actual = net.octosystems.foodversity.model.common.units.energy.Joule.of(5).getSymbol().toString()
    ...
    fun `Conversion of 1 KiloCalorie to Joule is 4186,8`() {
        ...
        val actual = net.octosystems.foodversity.model.common.units.energy.Joule.of(kCal)
    ...
    fun `Conversion of 1 KiloJoule to Joule is 1000`() {
        ...
        val actual = net.octosystems.foodversity.model.common.units.energy.Joule.of(kj)
    ...
    fun `Conversion of 1 Calorie to Joule is 4,1868`() {
        ...
        val actual = net.octosystems.foodversity.model.common.units.energy.Joule.of(cal)
